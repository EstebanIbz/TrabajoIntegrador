...
class Tanque {
  ...
  public Tanque(PVector posicion) { //Costructor parametrizado
    ...
    this.colider = new Collider (transform, 60);
    this.perder = false;
    this.puntaje = 0;
  ...
  public void disparar() { //Metodo para disparar, añadiendo balas al gestor balas creado en el escenario
